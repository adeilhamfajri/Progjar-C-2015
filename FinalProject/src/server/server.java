...
public class server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
          ...
          Inti_Program program = new Inti_Program(client_socket);
          Thread thread_12 = new Thread(program);
          thread_12.start();
    ...
    private static class Inti_Program implements Runnable {
    ...
    String sinyal = "terus";
        ...
        private Inti_Program(Socket client_socket) {
